 ...
 */
public class ComponentSelectorAdapter extends BaseExpandableListAdapter {
    ...
    public ComponentSelectorAdapter(Context context, List<ComponentSelectorCategory> itemList) {
